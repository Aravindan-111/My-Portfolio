            ...
            <Row>
              <Col lg={4} sm={12}>
                ...
                >
                      ...
                      <div className="flip-card-inner">
                        <div className="flip-card-front">
                          ...
                          <Card.Body>
                            ...
                            <Card.Text>
                              <p align="center">
                                A Chrome Extension which can detect whether the
                                input text is Positive or Negative.
                              </p>
                            </Card.Text>
                          </Card.Body>
                        </div>
                        <div className="flip-card-back">
                          <p>
                            Implemented Linear Regression Algorithm of
                            Scikit-Learn library on well-preprocessed dataset of
                            Kaggle.
                            <br></br>Hosted the Machine Learning Model on Heroku
                            and Mia, integrated the hosted model in a Chrome
                            Extension.
                  ...
                  <div>
                    <a
                      href="https://miamarketplace.com/apps/LG7MrdG4a9anFy3ZxQ4hiHeGZEQtsAlpkt0JBGz3fvJs"
                      target="_blank"
                    ...
                    <a
                      href="https://github.com/Tejaswi-Chaudhari/Toxic-Comment-Classification"
                      target="_blank"
                      rel="noreferrer noopener"
                    >
                      <Button
                      ...
                      <div className="flip-card-inner">
                        <div className="flip-card-front">
                          ...
                          <Card.Body>
                            ...
                            <Card.Text>
                              <p align="center">
                                During this internship, I am building a web app
                                to help people with their public speaking
                                ability
                              </p>
                            </Card.Text>
                          </Card.Body>
                        ...
                        <div className="flip-card-back">
                          <p>
                            Planned the UI for website and designed frontend
                            using ReactJs and React-Bootstrap
                            <br></br>Built Database models using Django Rest
                      ...
                      <div className="flip-card-inner">
                        <div className="flip-card-front">
                          ...
                          <Card.Body>
                            ...
                            <Card.Text>
                              <p align="center">
                                Current GDSC Lead and Former-Core Team Member of
                                GDSC UMIT
                              </p>
                            </Card.Text>
                          </Card.Body>
                        ...
                        <div className="flip-card-back">
                          <p>
                            Created and managing a team of 18 people and a
                            community of 300+ members
                            <br></br>Organized Study Jams, Hackathons and
                            Webinars.
                            <br></br>Hosted events of Google Cloud and Machine
                            Learning.
                            <br></br>Guided students in Google Cloud and Android
                            Development Study Jams
                          </p>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="flip-card-inner">
                        <div className="flip-card-front">
                          ...
                          <Card.Body>
                            ...
                            <Card.Text>
                              <p align="center">
                                Representative of Department of Computer Science
                                and Technology, UMIT
                              </p>
                            </Card.Text>
                          </Card.Body>
                        ...
                        <div className="flip-card-back">
                          <p>
                            Managed and helped students in their curriculum and
                            other difficulties.
                            <br></br>Co-organized annual fest 'Arcane
                            Illusions'.
                            <br></br>Coordinated between faculties and students
                            about studies and other activities.
                          </p>
                        </div>
                      </div>
                    </div>
